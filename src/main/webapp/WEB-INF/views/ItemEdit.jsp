						...
						<!-- spring form starts here -->
								...
								<!-- Row #1 -->
										<div class="row form-group">
											<div class="col-4">
												<label for=itemId class="control-label">
													Item Id
												</label>
											</div>	
											<div class="col6">
												<form:input path="itemId" readOnly="true" class="form-control"/>
									...
									<!-- Row #2 -->
										<div class="row form-group">
											...
											<div class="col6">
												<form:input path="itemCode" readOnly="true" class="form-control"/>
										...
										<!-- Row #4 -->
											<div class="row form-group">
												...
												<div class="col-6">
													<form:input path="itemBaseCost"  readOnly="true" class="form-control"/>
												</div>
											</div>	
