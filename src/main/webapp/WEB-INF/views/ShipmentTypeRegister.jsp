...
<html lang="en">
 <head>
   ...
   <title>ShipmentType Registration</title>
 </head>
 <body>
	<div class="container">
		...
		<div class="card">
			...
			<!-- card header starts from here -->
					<div class="card-header bg-primary text-white">
							<h3>Welcome to Shipment Type Registartion page</h3>
					</div>
								...
								<form:form action="save" method="POST" modelAttribute="shipmentType">
										...
										<!-- Row #2-->
												<div class="row form-group">
														...
														<div class="col-6">
																<form:input required="required" placeholder="Enter Shipment Code Here"  path="shipmentCode" class="form-control"/>
														</div>
												</div>  <!-- Row ended -->
									...
									<!-- submit  button-->
											...
											<a href="data" role="button" class="btn btn-success">View All</a>
