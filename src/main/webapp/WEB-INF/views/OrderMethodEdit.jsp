...
<title>OrderMethod Edit Register</title>
 </head>
 <body>
	<div class="container">
			...
			<div class="card">
				<!-- card header start from here -->
					<div class="card-header bg-primary text-white">
							<h3>Welcome to Order Method  Edit Register</h3>
					</div>
							...
							<form:form action="update" method="POST" modelAttribute="orderMethod">
								...
								<!-- Row #1 -->
										<div class="row">
												...
												<div class="col-4">
														<label for="orderMethodId" class="control-label">
																orderMethodId
															</label>
												</div>
												<div class="col-6">
														<form:input path="orderMethodId" readOnly="true" class="form-control"  />
									...
									<!-- Row #1 -->
										<div class="row form-group">
												...
												<div class="col-6">
													<form:radiobutton path="orderMethodMode" value="SALE" />Salenbsp &nbsp
